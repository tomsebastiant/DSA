 ...
 * regardless of isEnd â€” the only difference between a prefix match and a full-word match.
 */
public class M_Trie {
    ...
    public boolean startsWith(String prefix) {
        ...
        // Any reachable node means the prefix exists â€” isEnd is irrelevant here.
        return true;
    }
}

 ...
 * LC: 455
 ...
 Approach:
 Use two pointers i and j to scan children and cookies.
 Assign smallest sufficient cookie to each child greedily.
 Return how many children get content (which is i)..
 */
public class E_AssignCookies {

...
/**
 ...
 Approach:
 Farthest is the longest you can jump. Currentjump is the length
 of the current current jump. When we have reached the limit of the
 current jump, go to the current farthest and increment jump;
 */

public class M_45_JumpGame2 {

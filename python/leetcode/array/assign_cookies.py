class E_AssignCookies:
    ...
    Approach:
    Use two pointers to scan children and cookies after sorting both arrays.
    Assign the smallest sufficient cookie to each child greedily.
    """
